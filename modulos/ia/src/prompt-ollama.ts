...
- CORRIGIR_MOVIMENTO: alterar descrição/valor/categoria/data (campos_alterados), esconder dos relatórios (ignorado_em_relatorio=true), tags, OU excluir (status cancelado). "alterar data … para 15/08/2026" é correção, NÃO recorrência. "Corrigir/alterar/esconder" NÃO é exclusão; só apagar/excluir/cancelar → status cancelado.
