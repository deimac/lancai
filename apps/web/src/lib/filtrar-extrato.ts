...
export type CartaoCicloExtrato = {
  id: string;
  fechamento?: number | null;
  vencimento?: number | null;
  /** Usado só pra decidir se o ciclo já está pago — ver `adiar_compras_do_fechamento_ja_pago`. */
...
export function filtrar_extrato(
  ...
  const filtrados = movimentosDoRecorte.filter((movimento) =>
