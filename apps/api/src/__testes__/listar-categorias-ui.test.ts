...
describe("agregar_totais_por_categoria", () => {
  it("compra pós-fechamento entra no mês da fatura; o mesmo limite vale nos dois meses", () => {
    ...
    const agosto = agregar_totais_por_categoria(movimentos, "2026-08", fechamentoPorCartao);
    const setembro = agregar_totais_por_categoria(movimentos, "2026-09", fechamentoPorCartao);
