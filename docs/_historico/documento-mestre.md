...
>
> Este documento **não é mais a fonte da verdade**. Seu conteúdo foi redistribuído no conjunto numerado em [`docs/`](../00-VISAO_DA_ARQUITETURA.md).
>
> - Nomenclatura e entidades: [01-DOMINIO.md](../01-DOMINIO.md)
> - Modelo de dados: [07-MODELO_DE_DADOS.md](../07-MODELO_DE_DADOS.md)
> - Contratos da IA: [08-CONTRATOS.md](../08-CONTRATOS.md)
> - Regras do `MotorFinanceiro` e PF/PJ: [09-REGRAS_DE_NEGOCIO.md](../09-REGRAS_DE_NEGOCIO.md)
> - Visão de produto: [05-PRD.md](../05-PRD.md)
> - Stack e infraestrutura: [02-ARQUITETURA.md](../02-ARQUITETURA.md) e [15-OPERACAO.md](../15-OPERACAO.md)
...
Os **ADR-009 a ADR-014** estão em [adr/](../adr/README.md).
